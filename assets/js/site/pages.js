            ...
            <div class="container d-grid gap-5">
                ...
                <div class="welcome-banner reveal-on-scroll">
                    <div class="welcome-banner__image">
                        <img src="assets/images/school.jpg" alt="School Building" loading="lazy">
        ...
        <section class="section-shell">
            <div class="container d-grid gap-5">
                ...
                <div class="welcome-banner reveal-on-scroll">
                    ...
                    <div class="welcome-banner__image">
                        <img src="assets/images/school.jpg" alt="School Heritage" loading="lazy">
                        <div class="welcome-banner__image-overlay">
                            <div class="welcome-badge">
    ...
    template: `
        <section class="section-shell">
            <div class="container d-grid gap-5">
                ...
                <div class="welcome-banner reveal-on-scroll">
                    <div class="welcome-banner__image">
                        <img src="assets/images/school.jpg" alt="School Location" loading="lazy">
                        <div class="welcome-banner__image-overlay">
